/****************************************************************************
** Form interface generated from reading ui file 'externalForm.ui'
**
...
#ifndef EXTERNALFORM_H
#define EXTERNALFORM_H
...
class ExternalForm : public QWidget
{
    Q_OBJECT

public:
    ExternalForm( QWidget* parent = 0, const char* name = 0, Qt::WFlags fl = 0 );
    ~ExternalForm();
...
protected:
    ...
    Q3HBoxLayout* layout34;
    QSpacerItem* spacer7;
    Q3VBoxLayout* layout4;
    Q3VBoxLayout* layout33;
